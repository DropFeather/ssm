...
public class StringUtil {
    ...
    public static boolean containerString(String str1,String str2){
    ...
    public static void main(String[] args){
        ...
        System.out.println("container"+containerString("/authuser/index.do?jsession","/authuser/index.do"));
    }
